...
class App extends Component{
    ...
    render() {
        ...
        for(let i=0;i<this.state.containercolumn;i++){
            ...
            if(i==0){
                temp.push(<div style={{position:"relative",top:0,marginLeft:0,float: "left",width:"320px"}}><LineContainer key ={key} ref={key}/></div>);
            }else{
                temp.push(<div style={{position:"relative",top:0,marginLeft:this.state.containergap,float: "left",width:"320px"}}><LineContainer key ={key} ref={key} /></div>);
            }
        }
        return(
            <div >
